...
%
%   [polygon,lcBounds,rcBounds,sBounds]  = ...
%       worm2poly(startSI,endSI,skeleton,headCI,tailCI,contour,*sCCLengths,*cCCLengths)
%
%   Inputs:
%       startSI     - the skeleton index for the start of the worm segment
%       endSI       - the skeleton index for the end of the worm segment
...
%JAH NOTE: I haven't looked at this function all that closely
...
if startSI > endSI
    [startSI,endSI] = deal(endSI,startSI);
end
